 ...
 * Все пути ресурсов интерпретируются относительно каталога ресурсов приложения.
 */
public class FileUtils {
     ...
     * 
     * @param resourcePath путь к ресурсу (например, "1/in/f2.png")
     * @return массив байтов из файла ресурса
     * @throws IOException если ресурс не найден или при чтении произошла ошибка
     */
    ...
    /**
     * Записывает данные в файл, создавая недостающие директории по пути.
     * 
     * @param filePath путь к файлу для записи (например, "src/main/resources/1/out/a.bmp")
    ...
    /**
     * Читает данные из обычного файла по файловой системе.
     * 
    ...
    /**
     * Проверяет существование ресурса в classpath.
     * 
