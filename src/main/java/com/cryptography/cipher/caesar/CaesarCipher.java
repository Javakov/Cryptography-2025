...
public class CaesarCipher {
    ...
    public static byte[] encrypt(byte[] data, int key) {
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            // Используем & 0xFF для нормализации результата к диапазону [0..255]
     ...
     *
     * <p>
     * Нормализуем ключ по модулю 26, отдельно обрабатываем верхний и нижний регистр.
     * Прочие символы (включая пробелы, знаки препинания, кириллицу) возвращаются без изменений.
     * </p>
     */
